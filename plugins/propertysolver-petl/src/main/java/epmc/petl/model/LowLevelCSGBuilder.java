...
public class LowLevelCSGBuilder implements LowLevel.Builder{
    ...
    private Set<Object> fixProperties(Set<Object> properties) {
        ...
        for (Object property : properties) {
            if (property instanceof RewardSpecification) {
                ...
                RewardStructure rewardStructure = ((ModelMAS) model).getModelPrism().getReward(rewardSpecification);
    ...
    public ModelJANI toJANI(boolean forExporting) {
        PRISM2JANIConverter converter = new PRISM2JANIConverter(((ModelMAS) model).getSynModel(), forExporting);
