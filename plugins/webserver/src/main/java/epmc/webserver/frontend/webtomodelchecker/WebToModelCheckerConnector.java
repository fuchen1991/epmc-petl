...
//		List<Map<String, String>> wboptions = UtilOptionsEPMC.getWebOptions(language);
		List<Map<String, String>> wboptions = null;
...
//		}
	...
	public static ParseResult checkParsingModel(String language, String modelType, String model) {
        ...
        Map<String,Class<Model>> modelInputMap = options.get(OptionsWebserver.MODEL_CLASS);
        Class<Model> modelClass = modelInputMap.get(options.get(OptionsModelChecker.MODEL_INPUT_TYPE));
