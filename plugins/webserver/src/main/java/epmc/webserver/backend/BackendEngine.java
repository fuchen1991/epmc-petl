...
//
	...
	private static String epmcLogDirectory;
	/**
	 ...
	 */
	public static String epmcLogDirectory() {
		return epmcLogDirectory;
	}
	...
	public static void main(String args[]) {
		...
		String db_username = conf.getProperty("db_username", "root");
		String db_password = conf.getProperty("db_password", "123");
